...
namespace IO.Swagger.Model {
  ...
  public class StationBoardWithDetails {
    /// <summary>
    /// Gets or Sets TrainServices
    /// </summary>
    [DataMember(Name="trainServices", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "trainServices")]
    public List<ServiceItemWithCallingPoints> TrainServices { get; set; }

    /// <summary>
    /// Gets or Sets BusServices
    /// </summary>
    [DataMember(Name="busServices", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "busServices")]
    public List<ServiceItemWithCallingPoints> BusServices { get; set; }

    /// <summary>
    /// Gets or Sets FerryServices
    /// </summary>
    [DataMember(Name="ferryServices", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "ferryServices")]
    public List<ServiceItemWithCallingPoints> FerryServices { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class StationBoardWithDetails {\n");
      sb.Append("  TrainServices: ").Append(TrainServices).Append("\n");
      sb.Append("  BusServices: ").Append(BusServices).Append("\n");
      sb.Append("  FerryServices: ").Append(FerryServices).Append("\n");
